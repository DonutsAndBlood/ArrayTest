package unidade1;
/*
 * Faça uma classe que define um objeto Aluno com os seguintes atributos: 
 * nome, matricula (int), duas notas e média. 
 * 
 * Faça o construtor, os métodos gets e sets, toString e compareTo 
 * (que compara o nome de dois alunos e devolve o resultado da comparação 
 * deste atributo nome).
 */
public class Aluno {
	private String nome;
